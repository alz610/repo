...
\title{Разработка математических моделей и численных решений задач фильтрации и электрометрии и методов ускорения расчетов}
\subtitle{Научно-исследовательская работа на тему:}
\author{
Докладчик:\\
